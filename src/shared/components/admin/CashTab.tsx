...
import DetailDrawer from "@/shared/components/common/DetailDrawer";
import {
  CreditCard,
  Wallet,
  Banknote,
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {payments.map((p) => (
              ...
              >
                <td className="p-2">
                  {p.type === "income" ? "Gəlir" : "Xərc"}
                </td>
                <td className="p-2">
                  {p.type === "income" ? p.source : p.category}
                </td>
                <td className="p-2">
                  {p.type === "income" ? p.customer : p.description}
                </td>
              ...
              <form className="space-y-4" onSubmit={handleIncomeSubmit}>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setIncomeForm((f) => ({ ...f, customer: e.target.value }))
                    }
                    required
                  />
                </div>
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setIncomeForm((f) => ({ ...f, source: e.target.value }))
                    }
                  >
                    ...
                    {paymentMethods.map((opt) => (
                      ...
                      >
                        <input
                          ...
                          onChange={() =>
                            setIncomeForm((f) => ({ ...f, method: opt.value }))
                          }
                    ...
                    {paymentStatuses.map((opt) => (
                      ...
                      >
                        <input
                          ...
                          onChange={() =>
                            setIncomeForm((f) => ({ ...f, status: opt.value }))
                          }
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setIncomeForm((f) => ({ ...f, details: e.target.value }))
                    }
                  />
                </div>
                {formError && (
              ...
              <form className="space-y-4" onSubmit={handleExpenseSubmit}>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setExpenseForm((f) => ({ ...f, details: e.target.value }))
                    }
                  />
                </div>
                {formError && (
