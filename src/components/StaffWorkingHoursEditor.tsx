...
const StaffWorkingHoursEditor: React.FC<StaffWorkingHoursEditorProps> = ({
  staffId,
}) => {
        ...
        {isLoading ? (
          ...
          <>
            ...
            {localHours.map((day) => (
              <div
                key={day.day_of_week}
                className="grid grid-cols-7 items-center py-2 border-b"
              >
                <div className="font-medium">{dayNames[day.day_of_week]}</div>
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        handleWorkingDayToggle(day.day_of_week, checked)
                      }
                    />
                    <Label>{!day.is_day_off ? "Working" : "Off"}</Label>
                  </div>
                </div>
