...
import { DollarSign, User, Phone, Mail, Briefcase, Tag } from "lucide-react";
  ...
  if (error) {
    return (
      <div className="text-red-500 p-4">
        Error loading staff details: {error}
      </div>
    );
  }
            ...
            <div className="flex-1 space-y-4">
              <div className="flex flex-col md:flex-row justify-between">
                <div>
                  ...
                  <p className="text-gray-500">
                    {selectedStaff.position || "Staff Member"}
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    Payment: {getPaymentTypeDisplay(selectedStaff.paymentType)}
                  </span>
                </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            {(selectedStaff.paymentType === "commission" ||
              selectedStaff.paymentType === "hybrid") && (
            ...
            {(selectedStaff.paymentType === "salary" ||
              selectedStaff.paymentType === "hybrid") && (
