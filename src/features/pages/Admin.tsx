...
import AdminVerticalNav from "@/shared/components/admin/AdminVerticalNav";
import AdminHeader from "@/shared/components/admin/AdminHeader";
import DashboardTab from "@/shared/components/admin/DashboardTab";
import CustomersTab from "@/shared/components/admin/CustomersTab";
import ServicesTab from "@/shared/components/admin/ServicesTab";
import ProductsTab from "@/shared/components/admin/ProductsTab";
import AppointmentsTab from "@/shared/components/admin/AppointmentsTab";
import SettingsTab from "@/shared/components/admin/SettingsTab";
import StaffTab from "@/shared/components/admin/StaffTab";
import AdminProfile from "@/shared/components/admin/AdminProfile";
import CustomerDetailPage from "./CustomerDetailPage";
import { useLocation, useParams } from "react-router-dom";
import CashTab from "@/shared/components/admin/CashTab";
...
const Admin: React.FC<AdminProps> = ({ initialTab }) => {
  ...
  const isCustomerDetail =
    location.pathname.startsWith("/admin/customers/") && customerId;
  ...
  useEffect(() => {
    if (config.app.isDevelopment) {
      console.log(
        "Admin loaded in",
        config.usesMockData ? "mock mode" : "API mode"
      );
    }
  }, []);
