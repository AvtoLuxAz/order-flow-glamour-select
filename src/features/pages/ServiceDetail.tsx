...
const services = [
  ...
  },
  {
    ...
    relatedProducts: [{ id: 3, name: "Hair Care Kit", price: 60 }],
  },
        ...
        <div className="flex flex-col lg:flex-row gap-10">
              ...
              <ul className="space-y-2 mb-6">
                {service.benefits.map((benefit, index) => (
                  <li key={index} className="flex items-start">
                    <span className="bg-glamour-100 text-glamour-800 font-semibold rounded-full p-1 mr-2">
                      ✓
                    </span>
                    <span>{benefit}</span>
                  </li>
          ...
          <div className="lg:w-1/3">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
              <h3 className="text-xl font-bold text-glamour-800 mb-4">
                Book this Service
              </h3>
              <p className="text-gray-600 mb-6">
                Ready to experience the benefits of our{" "}
                {service.title.toLowerCase()}? Book your appointment today.
              </p>

              <Button
                className="w-full bg-glamour-700 hover:bg-glamour-800 mb-4"
                size="lg"
                asChild
              >
