...
const products = [
  {
    ...
    description:
      "Hydrating face cream for daily use with natural ingredients that nourish and protect your skin. Suitable for all skin types and provides 24-hour hydration.",
    longDescription:
    ...
    size: "50ml",
    ingredients:
      "Water, Glycerin, Caprylic/Capric Triglyceride, Cetearyl Alcohol, Ceteareth-20, Sodium Hyaluronate, Ceramide NP, Aloe Barbadensis Leaf Juice, Tocopheryl Acetate, Panthenol, Allantoin, Butyrospermum Parkii (Shea) Butter, Simmondsia Chinensis (Jojoba) Seed Oil, Phenoxyethanol, Ethylhexylglycerin.",
    directions:
      "Apply a small amount to clean, dry skin morning and evening. Gently massage using upward motions until fully absorbed. For best results, use after cleansing and applying serums.",
    category: "Skin Care",
    relatedServices: [{ id: 1, name: "Facial Treatment", price: 150 }],
  },
  {
    id: "2",
    title: "Anti-Aging Serum",
    description:
      "Premium anti-aging formula with collagen that reduces fine lines and wrinkles. Our advanced formula boosts skin elasticity and promotes a youthful appearance.",
    longDescription:
  ...
  },
  {
    ...
    title: "Hair Care Kit",
    description:
      "Complete kit for healthy hair including shampoo, conditioner, and leave-in treatment. Specially formulated to repair damaged hair and add shine and volume.",
    longDescription:
    ...
    ingredients:
      "Shampoo: Water, Sodium Cocoyl Isethionate, Cocamidopropyl Betaine, Sodium Lauroyl Sarcosinate, Glycerin, Panthenol, Hydrolyzed Keratin, Argania Spinosa Kernel Oil, Phenoxyethanol, Ethylhexylglycerin. Conditioner: Water, Cetearyl Alcohol, Behentrimonium Chloride, Glycerin, Panthenol, Hydrolyzed Keratin, Argania Spinosa Kernel Oil, Phenoxyethanol, Ethylhexylglycerin.",
    directions:
      "Shampoo: Apply to wet hair, massage gently into scalp and hair, rinse thoroughly. Conditioner: After shampooing, apply generously to mid-lengths and ends, leave for 2-3 minutes, then rinse. Leave-in Treatment: Apply to damp, towel-dried hair, focusing on mid-lengths and ends. Style as usual.",
    category: "Hair Care",
    relatedServices: [{ id: 4, name: "Hair Styling", price: 80 }],
  },
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          <div className="lg:w-2/3">
            ...
            <div className="prose max-w-none mb-8">
              <h2 className="text-2xl font-semibold text-glamour-800 mb-4">
                Description
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div>
                  <h3 className="text-xl font-semibold text-glamour-800 mb-3">
                    Details
                  </h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
              {product.relatedServices &&
                product.relatedServices.length > 0 && (
                  <>
                    <h3 className="text-lg font-semibold text-glamour-800 mt-8 mb-4">
                      Related Services
                    </h3>
                      ...
                      {product.relatedServices.map((service) => (
                        <div key={service.id} className="border rounded-md p-4">
                          <div className="flex justify-between mb-2">
                            ...
                            <span className="text-glamour-700 font-semibold">
                              ${service.price}
                            </span>
                          </div>
                          <Button
              ...
              <div className="mt-8 p-4 bg-glamour-50 rounded-md">
                <h4 className="font-semibold text-glamour-800 mb-2">
                  Need Help?
                </h4>
                <p className="text-sm text-gray-600 mb-4">
                  Have questions about this product? Our beauty experts are here
                  to help!
                </p>
