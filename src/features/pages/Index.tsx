            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="flex-1 space-y-6">
                ...
                <p className="text-lg text-gray-700 max-w-xl">
                  Experience personalized beauty treatments in a luxurious
                  environment. Our expert staff is dedicated to enhancing your
                  natural beauty.
                </p>
                <div className="flex gap-4 pt-4 flex-col xs:flex-row">
                  <Button
                    className="bg-glamour-700 hover:bg-glamour-800 px-6 py-6 flex items-center justify-center"
                    size="lg"
                    asChild
                  >
                    <Link to="/booking">
              ...
              <div className="flex-1">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-4 -right-4 bg-white p-4 rounded-lg shadow-lg">
                    <p className="font-medium text-glamour-800">
        ...
        <section className="py-16">
          <div className="container">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-glamour-800 mb-4">
                Our Premium Services
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                We offer a wide range of beauty and wellness services to help
        ...
        <section className="py-16">
          <div className="container">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Hear from our satisfied clients about their experiences at
                Glamour Studio.
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
              <p className="text-xl text-gray-600 italic mb-6">
                "Glamour Studio completely transformed my look! The staff was
                professional and attentive, and the results exceeded my
                expectations. I've never felt more beautiful and confident."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-gray-200 rounded-full mr-4"></div>
                <div>
                  <h4 className="font-semibold text-glamour-800">
                    Sarah Johnson
                  </h4>
        ...
        <section className="py-16 bg-glamour-700 text-white">
          <div className="container text-center">
            ...
            <p className="text-lg max-w-2xl mx-auto mb-8">
              Book an appointment today and experience the difference with our
